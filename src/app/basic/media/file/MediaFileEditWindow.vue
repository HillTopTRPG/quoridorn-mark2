...
import UrlInfoForm from "@/app/basic/media/url/MediaUrlInfoForm.vue";
...
@Component({ components: { MediaFileInfoForm, UrlInfoForm, ButtonArea } })
export default class MediaFileEditWindow
