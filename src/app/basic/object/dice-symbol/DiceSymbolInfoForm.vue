...
import TrDiceSelectComponent from "@/app/basic/common/components/table-item/TrDiceSelectComponent.vue";
import TrPipsSelectComponent from "@/app/basic/common/components/table-item/TrPipsSelectComponent.vue";
